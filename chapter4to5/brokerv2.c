...
int main(void)
{
    ...
    float price, commission, commission2, value;
    ...
    /* Compute the comission of other */

    if (shareNum < 2000)
        commission2 = shareNum * 0.03f + 33;
    else
        commission2 = shareNum * 0.02f + 33;

    
    printf("Commission: $%0.2f\n", commission);
    printf("Commission of other is: $%0.2f\n", commission2);
    return 0;
